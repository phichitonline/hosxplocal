...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <!-- Title Page-->
    <title>HOSxP Local web view.</title>
                ...
                <div class="section__content section__content--p35">
                    <div class="header3-wrap">
                        <div class="header__logo">
                            <a href="#">
                                <img src="{{ URL('images/tph-logo-1.png') }}" alt="" />
                            </a>
                        </div>
                        <div class="header__navbar">
                            <ul class="list-unstyled">
                                <li>
                                    <a href="/?hn={{ $patient_hn }}">
                                ...
                                <li>
                                    <a href="#">
                                        ...
                                        <span class="bot-line"></span>คู่มือ</a>
                                </li>
                                <li class="has-sub">
                                    <a href="#">
                ...
                <section class="p-t-60 p-b-20">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="copyright">
                                    <p>Copyright © 2021 <a href="https://www.tphcp.go.th">โรงพยาบาลสมเด็จพระยุพราชตะพานหิน</a> by Dr.GHOST.</p>
                                </div>
                            </div>
                        </div>
                    </div>
